...
for x in data_files:
    ...
    for x in root[1]:
        if x.tag == "QSLINK":
            if x.attrib["relType"] == "IN":
                IN = IN + 1
            elif x.attrib["relType"] == "EC":
                EC = EC + 1
            elif x.attrib["relType"] == "TPP":
                TPP = TPP + 1
            elif x.attrib["relType"] == "DC":
                DC = DC + 1
            elif x.attrib["relType"] == "PO":
                PO = PO + 1
            elif x.attrib["relType"] == "NTPP":
                NTPP = NTPP + 1
            elif x.attrib["relType"] == "OUT":
                OUT = OUT + 1
            elif x.attrib["relType"] == "EQ":
                EQ = EQ + 1
